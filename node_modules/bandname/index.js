var data = {
    ...
    n_animal:           require('./data/n_animal.js').data,
    n_dark:             require('./data/n_dark.js').data, // dark metal nouns
    n_group:            require('./data/n_group.js').data,
    n_groupgangsta:     require('./data/n_groupgangsta.js').data, // gangsta group names
    n_mythcreature:     require('./data/n_mythcreature.js').data,
    
    adj_personality:    require('./data/adj_personality.js').data,
    adj_color:          require('./data/adj_color.js').data,
    adj_dark:           require('./data/adj_dark.js').data,
    
    name_first:         require('./data/name_first.js').data,
    
    prefix_dubstep:     require('./data/prefix_dubstep.js').data,
    prefix_rap:         require('./data/prefix_rap.js').data,
    
    suffix:             require('./data/suffix.js').data
}
...
var templates = {
    ...
    indie: [
        ...
        "{{adj_personality?}} {{name_first}} and the {{adj_color?}} {{n_abstract|n_animal|n_mythcreature}}",
        "{{adj_personality}} {{name_first[a0]}} and the {{adj_color?}} {{n_abstract|n_animal|n_mythcreature[a0]}}",
